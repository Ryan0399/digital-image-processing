    ...
    for i, (image_rgb, image_semantic) in enumerate(dataloader):
        ...
        if epoch % 5 == 0 and i == 0:
            save_images(
                ...
                image_semantic,
                outputs,
                r"02_DIPwithPyTorch\Pix2Pix\train_results",
                epoch,
            )
        ...
        for i, (image_rgb, image_semantic) in enumerate(dataloader):
            ...
            if epoch % 5 == 0 and i == 0:
                save_images(
                    ...
                    image_semantic,
                    outputs,
                    r"02_DIPwithPyTorch\Pix2Pix\val_results",
                    epoch,
                )
...
def main():
    ...
    train_dataset = FacadesDataset(
        list_file=r"02_DIPwithPyTorch\Pix2Pix\train_list.txt"
    )
    val_dataset = FacadesDataset(list_file=r"02_DIPwithPyTorch\Pix2Pix\val_list.txt")
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % 20 == 0:
            os.makedirs(r"02_DIPwithPyTorch\Pix2Pix\checkpoints", exist_ok=True)
            torch.save(
                model.state_dict(),
                f"02_DIPwithPyTorch\Pix2Pix\checkpoints/pix2pix_model_epoch_{epoch + 1}.pth",
            )
